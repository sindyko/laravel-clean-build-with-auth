...
return [
    ...
    | например, правила размера. Не стесняйтесь настраивать каждое из этих сообщений.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Строки пользовательского языка проверки
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие языковые строки используются для замены нашего атрибута-заместителя
    | на что-то более удобное для читателя, например «Адрес электронной почты» вместо
    | электронной почты». Это просто помогает нам сделать наше сообщение более выразительным.
    |
    */
